...
export const CountryMap = ({
  ...
  const googleMapsEmbedUrl = `https://www.google.com/maps/embed/v1/place?key=${import.meta.env.VITE_GOOGLE_MAPS_API_KEY}&q=${encodeURIComponent(countryName)}&language=pt&region=BR`;
